...
--Crear usuario
create user JARDINERIAS identified by secreto;
--Privelegio para conectarse
grant create session to JARDINERIAS;
--Recursos para crear tablas
GRANT resource to JARDINERIAS;
